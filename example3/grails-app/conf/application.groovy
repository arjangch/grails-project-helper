...
// Adds remember me
grails.plugin.springsecurity.rememberMe.cookieName='example3rememberme'
grails.plugin.springsecurity.rememberMe.alwaysRemember=false
grails.plugin.springsecurity.rememberMe.tokenValiditySeconds=65000000
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	[pattern: '/requestmap/**', access: ['permitAll']],
